...
import com.jkkg.hhtx.net.bean.AssetsDetailBean;
...
public class AssetsDetailAdapter extends RecyclerView.Adapter {
    private Context context;
    List<AssetsLogBean> o;
    String addressself;
    private OnClick mOnClick;

    public AssetsDetailAdapter(Context context, List<AssetsLogBean> o,String addressself) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AssetsDetailHolder(LayoutInflater.from(context).inflate(R.layout.item_asset_detail,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder1, int position) {
        AssetsDetailHolder holder= (AssetsDetailHolder) holder1;
    ...
    class AssetsDetailHolder extends RecyclerView.ViewHolder {
...
//        private final TextView asset_freeze1;
        ...
        public AssetsDetailHolder(@NonNull View itemView) {
            super(itemView);
            //数量
