...
public class MnemonicConfirmAdapter extends BaseQuickAdapter<String, MnemonicConfirmAdapter.ViewHolder> {

    public MnemonicConfirmAdapter() {
        super(R.layout.layout_mnemonic_confirm_item);
        //num=12
        for(int i=0;i<12;i++){
            getData().add("");
        }
