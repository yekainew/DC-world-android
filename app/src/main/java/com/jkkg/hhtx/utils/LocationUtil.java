...
public class LocationUtil {
    public static void getCurrentLocation(Context context, LocationCallBack locationCallBack) {
        ...
        if (!TextUtils.isEmpty(bestProvider)) {
            Timber.e("================LocationUtil bestProvider = " + bestProvider + "可用");
            ...
            Timber.e("================LocationUtil bestProvider = " +LocationManager.GPS_PROVIDER + "可用");
            ...
            Timber.e("================LocationUtil bestProvider = " +LocationManager.NETWORK_PROVIDER + "可用");
            locationM.requestLocationUpdates(LocationManager.NETWORK_PROVIDER, 0, 0, locationListener);
        } else {
            //定位不可用，提示打开GPS
            Timber.e("================LocationUtil定位不可用，提示打开GPS");
