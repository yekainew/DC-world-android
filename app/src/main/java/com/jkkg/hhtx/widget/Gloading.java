...
import com.jkkg.hhtx.utils.NetUtil;
...
public class Gloading {
    ...
    class GlobalAdapter implements Gloading.Adapter {
        ...
        class GlobalLoadingStatusView extends LinearLayout implements View.OnClickListener {
            ...
            public GlobalLoadingStatusView(Context context, Runnable retryTask) {
                ...
                LayoutInflater.from(context).inflate(R.layout.layout_view_global_loading_status, this, true);
