...
public class SpaceItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        switch (layoutManager) {
            ...
            case STAGGEREDGRIDLAYOUT:
                ...
                setStaggeredGridLayoutManager(outRect,view,parent,state);
                break;
            default:
                break;
        }
    ...
    /**
     * StaggeredGridLayoutManager spacing
     * @param outRect
     * @param view
     * @param parent
     * @param state
     ...
     * @param state
     */
    private void setStaggeredGridLayoutManager(Rect outRect, View view, RecyclerView parent, RecyclerView.State state){
        int position = parent.getChildAdapterPosition(view) - headItemCount;
        if (headItemCount != 0 && position ==  - headItemCount){
            return;
        }
