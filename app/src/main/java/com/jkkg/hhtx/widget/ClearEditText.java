...
import com.jkkg.hhtx.utils.EmojiFilter;
...
public class ClearEditText extends androidx.appcompat.widget.AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
     ...
     * 删除按钮的引用
     */
    private Drawable mClearDrawable = getResources().getDrawable(R.mipmap.et_delete);
    /**
     * 控件是否有焦点
     */
    ...
    private void init() {
        ...
        if(mClearDrawable==null){
            mClearDrawable = getResources().getDrawable(R.mipmap.et_delete);
        }
