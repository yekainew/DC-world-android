...
public class SpUtil {
    ...
    // 首选项名称
    public static final String PREFERENCE_NAME= DataSave.app.getPackageName()+"PREFERENCE";
    ...
    public void saveInt(String key, int value) {
        if(ed != null) {
            ...
            ed.commit();
                ...
                Log.e("Error","PreferenceUitl.saveInt ed is null");
        }
    }
    ...
    public void saveFloat(String key, float value) {
        if(ed != null) {
            ...
            Log.e("Error","PreferenceUitl.saveFloat ed is null");
        }
    }
